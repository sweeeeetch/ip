  ...
  <BaseModal
    ...
    <div class="space-y-5">
      <p class="text-sm text-neutral-600">
        Импорт принимает JSON, который формирует экспорт. Можно вставить текст прямо в поле ниже или загрузить файл. Если есть желание изменить конфиг, воспользуйтесь ИИ для изменения конфига в
        подходящем формате
      </p>
